...
const taskActions = {
  ...
  getAllCommentsOfSubtaskById: createAction(
    TASK_CONFIG.GET_ALL_COMMENT_OF_SUBTASK_BY_ID
  ),
...
export const deleteSubtaskMember = createAction(
  TASK_CONFIG.DELETE_SUBTASK_MEMBER
);
export const subtaskMemberMarkAsDone = createAction(
  TASK_CONFIG.SUBTASK_MEMBER_MARK_AS_DONE
);
...
export const getAllSubTaskRejection = createAction(
  TASK_CONFIG.GET_ALL_SUBTASK_REJECTION
);
export const getAllSubTaskOfTask = createAction(
  TASK_CONFIG.GET_ALL_SUBTASK_OF_TASK
);
export const taskSubtaskStateChange = createAction(
  TASK_CONFIG.TASK_SUBTASK_STATE_CHANGE
);
