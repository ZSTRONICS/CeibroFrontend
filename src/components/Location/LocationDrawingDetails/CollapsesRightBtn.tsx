...
const CollapsesRightBtn: React.FC<CollapsesBtnProps> = ({ collapseDiv, btnRightRotate }) => {
    return (
        <button
            style={{
            ...
            onClick={collapseDiv}
        >
            <Box sx={{ transform: `${!btnRightRotate ? 'rotate(180deg)' : ''}`, transition: 'all linear 0.30s' }}>
                <Locationarrow />
            </Box>
        </button >
