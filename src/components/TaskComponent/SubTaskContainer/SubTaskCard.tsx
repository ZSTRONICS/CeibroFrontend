      ...
      <>
        ...
        >
          <CustomStack gap={2}>
            ...
            <CustomStack gap={0.5} sx={{ maxWidth: "130px", width: "125px" }}>
          ...
          <CustomStack gap={0.5} sx={{ maxWidth: "180px", width: "180px" }}>
          ...
          <CustomStack gap={0.4} sx={{ maxWidth: "180px" }}>
            <Grid item container justifyContent="space-between">
              <CustomStack
                columnGap={0.5}
                sx={{ maxWidth: "180px", width: "180px" }}
              >
