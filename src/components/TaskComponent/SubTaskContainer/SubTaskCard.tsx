...
import { AttachmentIcon, InfoIcon } from "components/material-ui/icons";
...
function SubTaskCard({ subTaskDetail }: Props) {
  ...
  const SubHeader = () => {
    return (
      <>
        <CustomStack gap={1} className={classes.subHeaderContent}>
          ...
          >
            <Grid item container justifyContent="space-between">
              <CustomStack columnGap={0.5} rowGap={1}>
          ...
          <CustomStack gap={1} rowGap={10} sx={{ width: "115px" }}>
