import {
    ...
    List,
    ListItemText,
    Avatar,ListSubheader,TextField,Grid
  } from "@mui/material";
...
import { styled } from "@mui/system";
  ...
  function EditSubTask() {
    ...
    return (<>
      ...
      inset
        component="div"
        sx={{ position: "relative", "&.MuiListSubheader-root": { padding:'2px 11px 14px 2px' }}}
      >
    ...
    <List
    dense
    sx={{ width: "100%", bgcolor: "background.paper",  maxHeight:'600px', overflow:'auto', height:'100%'}}
    >
...
>
  ...
  <ListItemText
  secondaryTypographyProps={{maxWidth:'80px', width:"100%", borderRadius:'3px'}}
//   primaryTypographyProps={{}}
    primary={<>
    {/* <label style={{}}>added by</label> */}
    <ListUserName 
    // sx={{borderTop:'1px solid'}}
    >Ilja Nikolajev</ListUserName></>
    }
    secondary={<>
    <SubtaskState
        sx={{
