    ...
    return (
        <Grid  item xs={12} direction="row-reverse" className={classes.inputWrapper}>
            ...
            {pause ? (
                ...
                <PauseCircleOutlineSharp className={classes.icons} onClick={handlePause} />
            )}
            <AudioReactRecorder backgroundColor={"white"} canvasWidth={100} canvasHeight={100} state={recordState} onStop={stop} />
            {pause && url  && (
                <audio controls>
                    <source src={url} />
                </audio>
